                                        ...
                                        ?>
                                                <tr class="tritem" data-id="<?php echo $item_m->id; ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="" class="btn btn-sm btn-primary btnItemLoadData" data-url="<?= Url::toRoute("/menu/dynamic-menu/read") ?>" data-menu="<?php echo $item_m->id; ?>" data-role="<?php echo $item_m->role; ?>" data-version="<?php echo $item_m->row_version; ?>"> Load Data</button>
